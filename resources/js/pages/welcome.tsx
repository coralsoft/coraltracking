                        ...
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <div className="mb-6">
                                <div className="mb-2 flex items-center gap-2">
                                    <span className="inline-flex items-center rounded-sm border border-[#19140035] bg-[#FDFDFC] px-2 py-1 text-[11px] font-medium text-[#1b1b18] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#EDEDEC]">
                                        GPS Tracking
                                    </span>
                                    <span className="inline-flex items-center rounded-sm border border-[#19140035] bg-[#FDFDFC] px-2 py-1 text-[11px] font-medium text-[#1b1b18] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#EDEDEC]">
                                ...
                                <h1 className="mb-1 text-[15px] font-medium leading-[22px] lg:text-[16px]">
                                    CoralTracking: tu flotilla, siempre visible
                                </h1>
                                <p className="text-[#706f6c] dark:text-[#A1A09A]">
                                    Monitorea unidades, camiones y carros con ubicaciones en tiempo real, rutas históricas, paradas, geocercas y reportes.
                                </p>
                            </div>

                            <div className="mb-6 grid gap-3 lg:grid-cols-2">
                                <div className="rounded-md border border-[#19140035] bg-[#FDFDFC] p-4 dark:border-[#3E3E3A] dark:bg-[#0f0f0f]">
                                    <div className="mb-2 flex items-center justify-between">
                                        <p className="font-medium">Tiempo real</p>
                                        <span className="inline-flex items-center rounded-sm border border-[#19140035] px-2 py-0.5 text-[11px] text-[#1b1b18] dark:border-[#3E3E3A] dark:text-[#EDEDEC]">
                                            Live
                                        </span>
                                    </div>
                                    <ul className="space-y-1 text-[#706f6c] dark:text-[#A1A09A]">
                                        <li className="flex items-start gap-2">
                                            <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                            <span>Mapa con estado (en movimiento, detenido, sin señal)</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                            <span>Última ubicación, velocidad, rumbo y batería/ignición</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                            <span>Alertas por eventos y geocercas</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="rounded-md border border-[#19140035] bg-[#FDFDFC] p-4 dark:border-[#3E3E3A] dark:bg-[#0f0f0f]">
                                    ...
                                    <ul className="space-y-1 text-[#706f6c] dark:text-[#A1A09A]">
                                        <li className="flex items-start gap-2">
                                            <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                            <span>Recorridos por rango de fechas (replay)</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                            <span>Paradas, tiempos, distancias y tiempos de inactividad</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                            <span>Exportación para auditorías y operaciones</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>

                            <div className="mb-6 rounded-md border border-[#19140035] bg-[#FDFDFC] p-4 dark:border-[#3E3E3A] dark:bg-[#0f0f0f]">
                                <div className="mb-3 flex items-center justify-between gap-3">
                                    <div>
                                        <p className="font-medium">Unidades</p>
                                        <p className="text-[#706f6c] dark:text-[#A1A09A]">Organiza por camiones, carros y flotillas.</p>
                                    </div>
                                    <div className="flex gap-2 text-[11px]">
                                        <span className="inline-flex items-center rounded-sm border border-[#19140035] px-2 py-1 dark:border-[#3E3E3A]">
                                            Units
                                        </span>
                                        <span className="inline-flex items-center rounded-sm border border-[#19140035] px-2 py-1 dark:border-[#3E3E3A]">
                                            Fleets
                                ...
                                <div className="grid gap-3 lg:grid-cols-3">
                                    <div className="rounded-sm border border-[#19140035] bg-white p-3 dark:border-[#3E3E3A] dark:bg-[#161615]">
                                        <p className="font-medium">Camiones</p>
                                        <p className="text-[#706f6c] dark:text-[#A1A09A]">Carga, rutas y alertas.</p>
                                    </div>
                                    <div className="rounded-sm border border-[#19140035] bg-white p-3 dark:border-[#3E3E3A] dark:bg-[#161615]">
                                        <p className="font-medium">Carros</p>
                                        <p className="text-[#706f6c] dark:text-[#A1A09A]">Operación diaria y seguridad.</p>
                                    </div>
                                    <div className="rounded-sm border border-[#19140035] bg-white p-3 dark:border-[#3E3E3A] dark:bg-[#161615]">
                                        <p className="font-medium">Flotillas</p>
                                        <p className="text-[#706f6c] dark:text-[#A1A09A]">Vista por grupos y KPIs.</p>
                                    </div>
                                </div>
                            </div>

                            <div className="flex flex-wrap gap-3 text-sm leading-normal">
                                {auth.user ? (
                                    <>
                                        <Link
                                            href={route('dashboard')}
                                        ...
                                        <span className="inline-flex items-center text-[#706f6c] dark:text-[#A1A09A]">
                                            Tip: usa la búsqueda para encontrar placas o nombres de unidad.
                                        </span>
                                    </>
                                ) : (
                                    <>
                                        ...
                                        <span className="inline-flex items-center text-[#706f6c] dark:text-[#A1A09A]">
                                            Listo para integrar tus dispositivos GPS.
                                        </span>
                                    </>
                                )}
                            </div>
